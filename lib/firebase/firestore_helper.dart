...
class FireStoreHelper {
  ...
  List<Product> initProducts = [
    Product(
      ...
      imageUrl:
          'https://cdn.thewirecutter.com/wp-content/media/2021/02/whitesneakers-2048px-4197.jpg?auto=webp&quality=75&width=1024',
    ),
    Product(
      id: Uuid().v1(),
      name: 'Smartphone',
      ...
      imageUrl:
          'https://www.apple.com/newsroom/images/product/iphone/standard/Apple_iphone13_hero_09142021_inline.jpg.slideshow-medium_2x.jpg',
    ),
    Product(
      id: Uuid().v1(),
      name: 'Backpack',
    ...
    Product(
      ...
      imageUrl:
          'https://961souq.com/cdn/shop/products/img_proxy_060930ff-76ab-4fd9-b9b7-b2e47d208560.jpg?v=1649415376',
    ),
    Product(
      id: Uuid().v1(),
      name: 'Watch',
      ...
      imageUrl:
          'https://www.luxemontwatches.com/cdn/shop/articles/Mens_Elegant_Watches_1024x1024.jpg?v=1531440176',
    ),
    Product(
      id: Uuid().v1(),
      name: 'Camera',
      ...
      availableQuantity: 8,
      imageUrl:
          'https://m.media-amazon.com/images/I/61BKYlNqH6L._AC_UF894,1000_QL80_.jpg',
    ),
    Product(
      id: Uuid().v1(),
      name: 'Laptop',
      ...
      availableQuantity: 7,
      imageUrl:
          'https://media.wired.com/photos/631bb97dd884b4dcc94164e3/1:1/w_1390,h_1390,c_limit/How-to-Choose-a-Laptop-Gear-GettyImages-1235728903.jpg',
    ),
    Product(
      id: Uuid().v1(),
      name: 'T-shirt',
      ...
      imageUrl:
          'https://static.massimodutti.net/3/photos//2023/I/0/1/p/6823/540/251/6823540251_1_1_16.jpg?t=1659000423715&impolicy=massimodutti-itxmediumhigh&imwidth=500&imformat=chrome',
    ),
    Product(
      id: Uuid().v1(),
      name: 'Coffee Maker',
      ...
      imageUrl:
          'https://m.media-amazon.com/images/I/71uLuTiXQlL._AC_SL1500_.jpg',
    ),
    Product(
      id: Uuid().v1(),
  ...
  StreamBuilder<QuerySnapshot> buildRealTimeStreamWidget() {
    final CollectionReference collectionRef =
        _firestore.collection(_collectionName);
  ...
  Stream<List<Product>> getRealTimeStreamProduct() {
    final CollectionReference collectionRef =
        _firestore.collection(_collectionName);
    return collectionRef.snapshots().map((querySnapshot) {
      ...
      querySnapshot.docs.forEach((document) {
        ...
        // String fullName = data['full_name'] ?? ''; // Replace '' with a default value if needed
        // String company = data['company'] ?? ''; // Replace '' with a default value if needed
